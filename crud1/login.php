    ...
    if (isset($_POST["nome"]) && isset($_POST["cpf"])) {
        ...
        if ($resultado && mysqli_num_rows($resultado) > 0) {
            ...
            if ($is_admin) {
                ...
                header("Location: index.php?user=true");
            }
            exit; 
        } else {
            $message_type = 'error'; 
            $message_text = 'Você não possui cadastro ou não é um administrador válido.';
        }
        ...
        $message_type = 'info'; 
        $message_text = 'Por favor, preencha todos os campos corretamente.';
    }
}
?>
