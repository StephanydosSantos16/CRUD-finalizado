...
$adminLoggedIn = isset($_GET['admin']) && $_GET['admin'] === 'true';


$userLoggedIn = isset($_GET['user']) && $_GET['user'] === 'true';


if (isset($_GET['delete']) && $adminLoggedIn) {
    $id = $_GET['delete'];
...
if (isset($_POST['update']) && $adminLoggedIn) {
    $id = $_POST['id'];
    $nome = $_POST['nome'];
    $cpf = $_POST['cpf'];
...
if (isset($_GET['edit']) && $adminLoggedIn) {
    $id = $_GET['edit'];
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <?php if ($adminLoggedIn): ?>
                <td>
                    <a href="index.php?edit=<?php echo $user['id']; ?>&admin=true">Editar</a>
                    <a href="index.php?delete=<?php echo $user['id']; ?>&admin=true" onclick="return confirm('Tem certeza que deseja excluir?');">Excluir</a>
                </td>
                <?php endif; ?>
            </tr>
            <?php endforeach; ?>
        ...
        <?php if (isset($_GET['edit']) && $adminLoggedIn): ?>
